...
export const Homepage = () => {
  return (
    ...
    <Box>
      <Navbar />
      <Box
        h={{ lg: "230px", base: "470px" }}
        w={{ lg: "100%", base: "35%" }}
        border="1px solid white"
        backgroundImage="url('https://legacyscs.com/wp-content/uploads/2019/10/Warehouse-RFP-770x253.jpg')"
      >
        <Heading mt={20} color="white" filter="auto" brightness="100%">
        ...
        >
          <Flex direction={{ lg: "row", base: "column" }}>
            ...
            <Input
              ...
              w={{ lg: "40%", base: "75%" }}
              variant="filled"
              onChange={{ backgroundColor: "white" }}
      ...
      <Box width="100%" mt={8}>
        <Flex>
          <Box
            ...
            height="400px"
            border="1px solid white"
            backgroundImage="url('https://i0.wp.com/wnainc.com/wp-content/uploads/2017/01/mechanical-drawing-e1484917722138-1.jpg?w=973&ssl=1')"
          >
            <Box mt={250}>
              <Text color="white">Prefabricated Houses</Text>
              <Text color="white">Scaffolding Planks & Plates</Text>
      ...
      <Box width="100%" mt={8}>
        <Flex>
          <Box
            ...
            height="400px"
            border="1px solid white"
            backgroundImage="url('https://www.jobsandskills.wa.gov.au/sites/default/files/styles/course_page_image/public/course-page-images/jswa-course-electronics2.jpg?itok=FmC6aurk')"
          >
            <Box mt={250}>
      ...
      <Box width="100%" mt={8}>
        <Flex>
          <Box
            ...
            height="400px"
            border="1px solid white"
            backgroundImage="url('https://images.foxtv.com/static.fox5atlanta.com/www.fox5atlanta.com/content/uploads/2020/01/932/524/high-blood-pressure.jpg?ve=1&tl=1')"
          >
            <Box mt={250}>
            ...
            <Grid templateColumns="repeat(3, 1fr)" gap={4}>
              <GridItem boxShadow={"2xl"}>
                <Flex>
                  <Box>
                    <Image
                      src="https://hm.imimg.com/imhome_gifs/cvid09.png"
                      alt=""
                    />
                  </Box>
                  ...
                  <Box>
                    ...
                    <Text>Blood Bank Equipments Hematology Analyzers</Text>
                  </Box>
                </Flex>
              </GridItem>
              ...
              <GridItem boxShadow={"2xl"}>
                <Flex>
                  <Box>
                    <Image
                      src="https://5.imimg.com/data5/IW/EI/MY-3076857/patient-monitoring-system-125x125.jpg"
                      alt=""
                    />
                  </Box>
                  ...
                  <Box>
                    ...
                    <Text>Medical Monitor Surgical Monitor</Text>
                  </Box>
                </Flex>
              </GridItem>
              ...
              <GridItem boxShadow={"2xl"}>
                <Flex>
                  <Box>
                    <Image
                      src="https://5.imimg.com/data5/NT/KF/MY-1383163/infrared-thermometer-125x125.jpg"
                      alt=""
                    />
                  </Box>
              ...
              <GridItem boxShadow={"2xl"}>
                <Flex>
                  <Box>
                    <Image
                      src="https://5.imimg.com/data5/CM/CP/JH/SELLER-5038493/neonatal-portable-icu-ventilator-125x125.jpg"
                      alt=""
                    />
                  </Box>
                  ...
                  <Box>
                    ...
                    <Text>ECG Machine Doppler Machine</Text>
                  </Box>
                </Flex>
              </GridItem>
              ...
              <GridItem boxShadow={"2xl"}>
                <Flex>
                  <Box>
                    <Image
                      src="https://5.imimg.com/data5/OQ/SV/MY-905156/stethoscope-cardio-125x125.jpg"
                      alt=""
                    />
                  </Box>
                  ...
                  <Box>
                    ...
                    <Text>Electronic Stethoscope Pediatric Stethoscope</Text>
                  </Box>
                </Flex>
              </GridItem>
              ...
              <GridItem boxShadow={"2xl"}>
                <Flex>
                  <Box>
                    <Image
                      src="https://5.imimg.com/data5/NU/ZZ/AQ/SELLER-35236796/electric-suction-unit-125x125.jpg"
                      alt=""
                    />
                  </Box>
                  ...
                  <Box>
                    ...
                    <Text>Liposuction Machine Central Suction System</Text>
                  </Box>
                </Flex>
              </GridItem>
            </Grid>
      ...
      <Box width="100%" mt={8}>
        <Flex>
          <Box
            ...
            height="400px"
            border="1px solid white"
            backgroundImage="url('https://media.bizj.us/view/img/11639152/lewis-logistics-forkllift*480xx1500-2000-0-0.jpg')"
          >
            <Box mt={250}>
            ...
            <Grid templateColumns="repeat(3, 1fr)" gap={4}>
              <GridItem boxShadow={"2xl"}>
                <Flex>
                  <Box>
                    <Image
                      src="https://5.imimg.com/data5/TM/DV/LX/SELLER-33028307/corporate-domestic-courier-service-125x125.jpg"
                      alt=""
                    />
                  </Box>
              ...
              <GridItem boxShadow={"2xl"}>
                <Flex>
                  <Box>
                    <Image
                      src="https://5.imimg.com/data5/UU/AO/IG/SELLER-47839771/local-shifting-service-125x125.jpg"
                      alt=""
                    />
                  </Box>
              ...
              <GridItem boxShadow={"2xl"}>
                <Flex>
                  <Box>
                    <Image
                      src="https://5.imimg.com/data5/SR/AM/MY-4376139/cargo-shipping-service-125x125.jpg"
                      alt=""
                    />
                  </Box>
              ...
              <GridItem boxShadow={"2xl"}>
                <Flex>
                  <Box>
                    <Image
                      src="https://5.imimg.com/data5/HD/KA/QI/GLADMIN-65832/heavy-duty-truck-125x125.jpg"
                      alt=""
                    />
                  </Box>
                  ...
                  <Box>
                    ...
                    <Text>
                      Lorry Transport Services Container Truck Service
                    </Text>
                  </Box>
                </Flex>
              </GridItem>
              ...
              <GridItem boxShadow={"2xl"}>
                <Flex>
                  <Box>
                    <Image
                      src="https://5.imimg.com/data5/UE/AD/MY-37442849/local-logistics-service-125x125.jpg"
                      alt=""
                    />
                  </Box>
                  ...
                  <Box>
                    ...
                    <Text>
                      Local Logistics Services Contract Logistics Service
                    </Text>
                  </Box>
                </Flex>
              </GridItem>
              ...
              <GridItem boxShadow={"2xl"}>
                <Flex>
                  <Box>
                    <Image
                      src="https://5.imimg.com/data5/SR/RI/MY-12870604/parcel-delivery-services-125x125.jpg"
                      alt=""
                    />
                  </Box>
      ...
      <Box width="100%">
        <Grid templateColumns="repeat(3, 1fr)" gap={10}>
          <GridItem>
            <Image
              width="80%"
              src="https://file.mk.co.kr/meet/neds/2022/04/image_readtop_2022_378930_16511440605025338.jpg"
              alt=""
            />
          </GridItem>
          ...
          <GridItem>
            <Image
              width="50%"
              src="https://www.opalpart.com/wp-content/uploads/2021/02/SANY.jpg"
              alt=""
            />
          </GridItem>
          ...
          <GridItem>
            <Image
              width="50%"
              src="https://storage.googleapis.com/impact-news-photo/news-photo/7526.Volume18_Issue05_68.jpg"
              alt=""
            />
          </GridItem>
          ...
          <GridItem>
            <Image
              width="50%"
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Atlas-Copco-Logo.svg/1200px-Atlas-Copco-Logo.svg.png"
              alt=""
            />
          </GridItem>
          ...
          <GridItem>
            <Image
              width="50%"
              src="https://seekvectorlogo.com/wp-content/uploads/2017/12/canon-vector-logo.png"
              alt=""
            />
          </GridItem>
          ...
          <GridItem>
            <Image
              width="30%"
              src="https://5.imimg.com/data5/SELLER/Default/2021/5/JM/WV/AH/16255361/jaguar-bathroom-fittings-500x500.jpg"
              alt=""
            />
          </GridItem>
        </Grid>
      ...
      <Box width="100%" mt={6}>
        <Grid templateColumns="repeat(4, 1fr)" gap={10}>
          <GridItem margin={"auto"}>
            <Image
              ml={100}
              src="https://4.imimg.com/data4/LG/EJ/MY-346460/rajabogam-ponni-rice-125x125.png"
              alt=""
            />
          ...
          <GridItem>
            <Image
              ml={100}
              src="https://5.imimg.com/data5/GY/FN/MY-3436896/ponni-rice-125x125.jpg"
              alt=""
            />
          ...
          <GridItem>
            <Image
              ml={100}
              src="https://5.imimg.com/data5/ANDROID/Default/2022/10/HU/UP/BI/5158094/product-jpeg-125x125.jpg"
              alt=""
            />
          ...
          <GridItem>
            <Image
              ml={100}
              src="https://5.imimg.com/data5/RH/FK/MY-13537206/boiled-ponni-rice-125x125.jpg"
              alt=""
            />
